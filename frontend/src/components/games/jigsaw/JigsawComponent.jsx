...
const JigsawComponent = () => {
  ...
  const handleSolved = () => {
    ...
    // Show confetti and ensure it renders
    console.log("Puzzle solved! Showing confetti...");
  ...
  // Debug output for confetti state
  useEffect(() => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-screen bg-gradient-to-br ${ageConfig.theme.bgGradient} p-4`} style={{ backgroundColor: ageConfig.theme.cardBg }}>
      {/* Always render Confetti but control visibility with props */}
