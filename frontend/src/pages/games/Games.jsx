...
const Games = () => {
  return (
    <div className="games-container pt-28 px-6 min-h-screen bg-[#F9F5EB]">
      <h1 className="text-3xl font-bold text-[#66220B] mb-8 quicksand">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link to="/games/seguin-board">
          <div className="game-card bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all">
            ...
            <h2 className="text-xl font-bold text-[#66220B] mb-4 text-center">
              Seguin Form Board
            </h2>
            <p className="text-gray-600 mb-4 text-center">
              Match shapes to their correct positions in this classic assessment
              tool.
            </p>
            <div className="flex justify-center">
              <span className="mt-4 text-[#F09000] font-semibold hover:underline">
                Start Playing →
              </span>
            </div>
          </div>
        ...
        <Link to="/games/monkeytype">
          <div className="game-card bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all">
            <div className="icon flex justify-center mb-4">
              <i className="fa-solid fa-keyboard text-4xl text-[#F09000]"></i>
            </div>
            <h2 className="text-xl font-bold text-[#66220B] mb-4 text-center">
              Speed Type Test
            </h2>
        ...
        <div className="game-card bg-white rounded-xl shadow-lg p-6 opacity-60 cursor-not-allowed">
          ...
          <p className="text-gray-600 mb-4 text-center">
            Measure reaction time and focus with this simple test.
          </p>
          <div className="flex justify-center">
            <span className="mt-4 text-[#F09000] font-semibold">
              Coming Soon
            </span>
          </div>
        </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-[#66220B] text-lg mb-4">
          These games are designed to help assess cognitive skills while being
          fun to play!
        </p>
